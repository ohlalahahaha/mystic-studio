  ...
  switch (name) {
    ...
    case 'photo_see': {
      ...
      try {
        ...
        const id = saveSession(c, 'photo_see', a.image, verdict);
    ...
    case 'web_review': {
      ...
      const law = LAW.DESIGN_LAW + (a.brief ? `\n\nBUSINESS CONTEXT: ${a.brief}` : '');
      ...
      const id = saveSession(c, 'web_review', a.url, `${verdict}\n\n--- MOBILE ---\n${mobVerdict}`, { shots: [desk, mob] });
...
module.exports = { dispatch, TOOLS, doctor, load: cfg.load };
